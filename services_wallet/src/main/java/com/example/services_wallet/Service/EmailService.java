...
import com.example.services_wallet.Util.EmailUtil;
...
public class EmailService {
    ...
    public static final String FROM_EMAIL = "testing14594@gmail.com";
    public static final String PASSWORD = "Total@123";
    public static void sendEmail(String toEmail) {
        Properties prop =getProperties();
        Authenticator auth = getAuthenticator();
        Session session = Session.getDefaultInstance(prop,auth);
        EmailUtil.sendEmail(session,toEmail,"Mail from eWallet!!!","Transaction");
    }

    public static void sendEmailWithAttachments(String host, String port, final String userName, final String password, String toAddress, String subject, String message, String attachFile) {
